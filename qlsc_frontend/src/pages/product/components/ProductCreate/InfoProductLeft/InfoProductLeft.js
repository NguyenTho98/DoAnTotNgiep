...
import "./styles.scss";
function InfoProductLeft(props) {
  const {} = props;
  useEffect(() => {}, []);
  return (
    <div className="info-product-left">
      ...
      <div className="card info-product-left-02">
...
InfoProductLeft.defaultProps = {};

export default React.memo(connect(null, null)(InfoProductLeft));
