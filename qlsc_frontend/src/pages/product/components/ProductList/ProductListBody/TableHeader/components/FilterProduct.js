...
import { showFilter } from '../../../../../actions/product';
    ...
    <div id="filter-product-wrapper">
      <div id="filter-product-by-tab-wrapper">
        <ul id="filter-product-by-tab">
          <li
            className="filter-product-tab active"
          >
              Tất cả sản phẩm
          </li>
        </ul>
      ...
      <div id="filter-product-info-wrapper">
        {props.filterInfo && props.filterInfo.selectedFilter && props.filterInfo.selectedFilter.map((filterName, index) => {
          ...
          return (
            <div className="filter-product-option-info" key={index}>
